 ...
 */
//% weight=10 color=#DF6721 icon="\uf013" block="STELR EV" groups=["Motors", "GamePad", "Distance Sensors"]
namespace stelrEV {
     ...
     * 0°~180°.
	*/
    //% blockId=stelr_ev_servo block="Servo|%index|degree|%degree"
    //% weight=100
    ...
    */
    //% weight=90
    //% blockId=stelr_ev_MotorRun block="Motor|%index|dir|%direction|speed|%speed"
    ...
    */
    //% weight=80
    //% blockId=stelr_ev_stepperDegree_42 block="Stepper 42|%index|dir|%direction|degree|%degree"
    //% index.fieldEditor="gridpicker" index.fieldOptions.columns=2
    //% direction.fieldEditor="gridpicker" direction.fieldOptions.columns=2
    //% group="Motors"
    ...
    */
    //% weight=70
    //% blockId=stelr_ev_stepperTurn_42 block="Stepper 42|%index|dir|%direction|turn|%turn"
    //% index.fieldEditor="gridpicker" index.fieldOptions.columns=2
    //% direction.fieldEditor="gridpicker" direction.fieldOptions.columns=2
    //% group="Motors"
    ...
    */
    //% weight=60
    //% blockId=stelr_ev_stepperDegree_28 block="Stepper 28|%index|dir|%direction|degree|%degree"
    //% index.fieldEditor="gridpicker" index.fieldOptions.columns=2
    //% direction.fieldEditor="gridpicker" direction.fieldOptions.columns=2
    //% group="Motors"
    ...
    */
    //% weight=50
    //% blockId=stelr_ev_stepperTurn_28 block="Stepper 28|%index|dir|%direction|turn|%turn"
    //% index.fieldEditor="gridpicker" index.fieldOptions.columns=2
    //% direction.fieldEditor="gridpicker" direction.fieldOptions.columns=2
    //% group="Motors"
    ...
    */
    //% weight=40
    //% blockId=stelr_ev_stepperDegreeDual_42 block="Dual Stepper %stepper|M1_M2 dir %direction1|degree %degree1|M3_M4 dir %direction2|degree %degree2"
    ...
    */
    //% weight=30
    //% blockId=stelr_ev_stepperTurnDual_42 block="Dual Stepper %stepper|M1_M2 dir %direction1|trun %trun1|M3_M4 dir %direction2|trun %trun2"
    //% stepper.fieldEditor="gridpicker" stepper.fieldOptions.columns=2
    //% direction1.fieldEditor="gridpicker" direction1.fieldOptions.columns=2
    //% direction2.fieldEditor="gridpicker" direction2.fieldOptions.columns=2
    //% group="Motors"
    ...
    */
    //% weight=20
    //% blockId=stelr_ev_motorStop block="Motor stop|%index"
    //% index.fieldEditor="gridpicker" index.fieldOptions.columns=2 
    //% group="Motors"
    ...
    */
    //% weight=10
    //% blockId=stelr_ev_motorStopAll block="Motor Stop All"
    //% group="Motors"
